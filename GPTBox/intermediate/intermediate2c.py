...
Again, only perform this task for the patient's medical conditions and NOT family medical conditions.
...
Peripheral Artery Disease:
Peripheral Artery Disease HCC 

Seizure:
Seizure HCC 

Rheumatological Disease:
Rheumatologic Disease HCC 
########
